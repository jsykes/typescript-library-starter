...
function setupLibrary(libraryName: string) {
  ...
  modifyContents(libraryName, username, usermail, 'UNLICENSED')
 ...
 * @param usermail
 */
function modifyContents(libraryName: string, username: string, usermail: string, license: string) {
  ...
  try {
    const changes = replace.sync({
      files,
      from: [/--libraryname--/g, /--username--/g, /--usermail--/g, /--license--/g],
      to: [libraryName, username, usermail, license]
    })
